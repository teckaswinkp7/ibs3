    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <a class="btn btn-primary" href="{{ route('admin.reports.confirmedstudents.index') }}"> Back</a>
              </div>
              <div class="col-sm-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" value="{{ $course->courses_name }}" name="selectedcourse" class="form-control"  readonly>
                               @endforeach
                              </div>
                            </div> 
