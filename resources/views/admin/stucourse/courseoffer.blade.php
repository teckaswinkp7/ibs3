            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Student Course Offer</li>
                </ol>
              </div>
            </div>
          </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" value="{{$student_course_offer[0]->courses_name}}" name="course_offer" class="form-control"  readonly>
                                <input type="hidden" value="{{$student_course_offer[0]->student_course_id}}" name="offer_course_id" class="form-control"  readonly>
                              </div>
                            </div> 
                            <div class="col-md-12">
                              <div class="form-group">
