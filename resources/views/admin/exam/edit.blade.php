          ...
          <div class="container-fluid">
            ...
            <div class="card card-default">
              <div class="card-header">
               ...
               <!-- /.card-header -->
               <form action="{{ route('exam.update',$exam->id) }}"  enctype="multipart/form-data" method="POST"  class="mb-0" id="examform">
                @csrf
                {{ method_field('GET') }}    
                    <div class="card-body">
                        @if(session('status'))
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <input type="text" value="{{ $exam->exam_name }}" name="exam_name" id="@if ($errors->has('exam_name')) inputError @endif" class="form-control @if ($errors->has('exam_name')) is-invalid @endif" placeholder="Exam Name">
                                @error('exam_name')
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="file" class="form-control"  name="exam_document" class="form-control">
                            </div>
                          </div>
                          <div class="col-md-12">
                              <div class="form-group">
                                <label>Exam Duration</label>
                                <input type="text" value="{{ $exam->exam_duration }}" name="exam_duration" id="@if ($errors->has('exam_duration')) inputError @endif" class="form-control @if ($errors->has('exam_duration')) is-invalid @endif">
                                @error('exam_duration')
                                  <span class="error invalid-feedback">{{ $message }}</span>
                                @enderror
                              </div>
