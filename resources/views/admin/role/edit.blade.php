          ...
          <div class="container-fluid">
            ...
            <div class="card card-default">
              <div class="card-header">
               ...
               <!-- /.card-header -->
               <form action="{{ route('role.update',$roles->id) }}" method="POST" enctype="multipart/form-data" class="mb-0" id="catform">
                @csrf
                {{ method_field('PUT') }}    
                    <div class="card-body">
                        @if(session('status'))
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary btnreview">Update</button>
                    </div>
                </form>
            </div>
            <!-- /.card -->
