...
<p align="center"><img src="{{asset('assets/front/images/IBS-Logo.png')}}"></p>  
    <h1 class="text-center m-0 p-0">Course Offer</h1>
     
</div>
<div class="add-detail mt-10">
    <div class="w-50 float-left mt-10">
        <p class="m-0 pt-5 text-bold w-100">Offer Id - <span class="gray-color">{{$invoice_id}}</span></p>
        <!-- <p class="m-0 pt-5 text-bold w-100">Order Id - <span class="gray-color">162695CDFS</span></p> -->
        <p class="m-0 pt-5 text-bold w-100">Offer Date - <span class="gray-color">{{date('Y-m-d')}}</span></p>
    </div>
