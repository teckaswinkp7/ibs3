    ...
    <div class="content-wrapper" style="min-height:1545px !important;">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <a class="btn btn-primary btnreview" href="{{ route('officer.index') }}"> Back</a>
              </div>
              <div class="col-sm-6">
          ...
          <div class="container-fluid">
            ...
            <div class="card card-default">
              <div class="card-header">
               ...
               <!-- /.card-header -->
               <form action="{{ route('officer.store') }}" method="POST" enctype="multipart/form-data" class="mb-0" id="catform">
                @csrf    
                    <div class="card-body">
                      <div class="row">
                        <!-- <div class="col-md-12">
