...
@section('content') 
  ...
  <div class="site-section">
    ...
    <div class="section-bg style-1" style="background-image:url({{asset('assets/front/images/hero_1.jpg')}});">
      <div class="container">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="post-entry-big">
                  <a href="news-single.html" class="img-link"><img src="{{asset('assets/front/images/blog_large_1.jpg')}}" alt="Image" class="img-fluid"></a>
              ...
              <div class="col-lg-6">
                <div class="post-entry-big horizontal d-flex mb-4">
                  <a href="news-single.html" class="img-link mr-4"><img src="{{asset('assets/front/images/blog_1.jpg')}}" alt="Image" class="img-fluid"></a>
                  <div class="post-content">
                    <div class="post-meta">
                      <a href="#">June 6, 2019</a>
                      <span class="mx-1">/</span>
                ...
                <div class="post-entry-big horizontal d-flex mb-4">
                  <a href="news-single.html" class="img-link mr-4"><img src="{{asset('assets/front/images/blog_2.jpg')}}" alt="Image" class="img-fluid"></a>
                  <div class="post-content">
                    <div class="post-meta">
                      <a href="#">June 6, 2019</a>
                      <span class="mx-1">/</span>
          ...
          <div class="col-lg-3">
            ...
            <a href="https://vimeo.com/45830194" class="video-1 mb-4" data-fancybox="" data-ratio="2">
              ...
              <img src="{{asset('assets/front/images/course_5.jpg')}}" alt="Image" class="img-fluid">
            </a>
            <a href="https://vimeo.com/45830194" class="video-1 mb-4" data-fancybox="" data-ratio="2">
                <span class="play">
                  <span class="icon-play"></span>
    ...
    <div class="site-section ftco-subscribe-1" style="background-image:url({{asset('assets/front/images/bg_1.jpg')}});">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7">
