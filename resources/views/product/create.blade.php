...
<!-- Main content -->
  ...
  <div class="card card-default">
    ...
    <!-- /.card-header -->
    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" class="mb-0" id="catform">
    @csrf    
      <div class="card-body">
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" name="name" id="@if ($errors->has('name')) inputError @endif" class="form-control @if ($errors->has('name')) is-invalid @endif" placeholder="Product Name">
              @error('name')
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" name="slug" id="@if ($errors->has('slug')) inputError @endif" class="form-control @if ($errors->has('slug')) is-invalid @endif" placeholder="Product Name">
              @error('slug')
              <span class="error invalid-feedback">{{ $message }}</span>
              @enderror
            </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" name="sale_price" id="@if ($errors->has('sale_price')) inputError @endif" class="form-control @if ($errors->has('sale_price')) is-invalid @endif" placeholder="Sale Price">
              @error('sale_price')
              <span class="error invalid-feedback d-block">{{ $message }}</span>
              @enderror  
            </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" name="regular_price" id="@if ($errors->has('regular_price')) inputError @endif" class="form-control @if ($errors->has('regular_price')) is-invalid @endif" placeholder="Regular Price">
              @error('regular_price')
              <span class="error invalid-feedback d-block">{{ $message }}</span>
              @enderror  
            </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="file" class="form-control"  name="product_image" id="@if ($errors->has('product_image')) inputError @endif" class="form-control @if ($errors->has('product_image')) is-invalid @endif">
              @error('product_image')
              <span class="error invalid-feedback d-block">{{ $message }}</span>
              @enderror  
            </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea class="ckeditor form-control" name="long_description" placeholder="Long Description"></textarea>
