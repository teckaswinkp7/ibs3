                    ...
                    <tr>
                      ...
                      <td>
                        <form action="<?php echo e(route('user.destroy',$user->id)); ?>" method="Post">
                          <a  href="<?php echo e(route('screening.course',$user->id)); ?>">   
...
<?php echo $__env->make('admin.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ibs\resources\views/admin/screening/index.blade.php ENDPATH**/ ?>