                ...
                <p> You have outstanding  on the following invoices: </p>
                    ...
                    <?php 
                      ...
                      <div class="edit-course">
                        ...
                        <p > Status: 
                            <?php if($statusis == 'Partially paid'): ?>
                            <span class= "badge badge-warning " ><?php echo e($total[0]->status); ?> </span> 
                            <?php else: ?>
                            <span class= "badge badge-danger " ><?php echo e($total[0]->status); ?> </span> 
                           <?php endif; ?>
...
<?php echo $__env->make('front/header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ibs\resources\views/front/invoice/confirmpayment.blade.php ENDPATH**/ ?>