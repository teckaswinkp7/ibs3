                ...
                <p> Pro Forma Invoice History:  </p>
                    <form action="">
                        ...
                        <th> Document   </th>
                            ...
                            <tbody>
                                <tr>
                                <td> $ <?php echo e($amountdue[0]->amountdue); ?> </td>
                                <td>  <?php 
$date = $total[0]->updated_at;
$dt = new DateTime($date);
echo $dt->format('Y-m-d');
?> </td>
                                <td> <a href="<?php echo e(route('invoice')); ?>"> Download </a> </td>
</tr>
</tbody>
...
?> </td>
                                ...
                                <td> -- </td>
                                <td> -  </td>
                                <td> <?php echo e($amountdue[0]->status); ?> </td>
</tr>
</tbody>
...
<?php echo $__env->make('front/header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ibs\resources\views/front/invoice/history.blade.php ENDPATH**/ ?>