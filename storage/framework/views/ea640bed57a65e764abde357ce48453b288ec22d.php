                    ...
                    <form action="">
                      <div class="congrats-course">
                        ...
                        <div class="congrats-letter">
                            <a href="#"><img src="<?php echo e(asset('assets/custom/profile-logo.png')); ?>" alt="" width="150px"></a>
                            <p>
                                <?php echo date("l jS \of F Y"); ?>
                                 <br> <br>
                                Dear <?php echo e($student_course_offer[0]->uname); ?>, <br> <br>
                      ...
                      <div class="print-download-btn">
                        <button class=""><img src="<?php echo e(asset('assets/custom/download-icon.png')); ?>" alt="" width="15px"></button>
                        <button class=""><img src="<?php echo e(asset('assets/custom/print-icon.png')); ?>" alt="" width="15px"></button>
                      </div>
                      <div class="congrats-btn">
                      <a href="<?php echo e(route('proformainvoice')); ?>"> <button class="proinvoice-btn">Pro-Invoice </a></button>
                      </div>
                   </form>
...
<?php echo $__env->make('front/header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ibs\resources\views/front/education/offer-congrats.blade.php ENDPATH**/ ?>