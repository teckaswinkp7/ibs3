        ...
        <div class="submission-modal">
            ...
            <form action="" class="submission-form">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="text" value="<?php echo e($newval[0]->board); ?> " disabled>
                </div>
                <div class="col-sm-3">
                    <p>Status</p>
                ...
                <?php if($newval[0]->verification_status != 2): ?>
                <div class="submission-btn">
                <button class=""><a style="color: #fff; text-decoration:none;" href="<?php echo e(route('userprofiles')); ?>">Prompt review</a></button>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('front/header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ibs\resources\views/front/education/document_submit.blade.php ENDPATH**/ ?>