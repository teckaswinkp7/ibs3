<footer class="main-footer">
    <strong>Copyright &copy;2021 <a href="#">IBS</a></strong>
    All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
<script src="<?php echo e(asset('assets/admin/demo/chart-area-demo.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/demo/chart-bar-demo.js')); ?>"></script>
<!-- DataTables  & Plugins -->
...
<script>
  $(function () {
    $("#example1").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,"pageLength": 5, "paging": true,
...
</script><?php /**PATH C:\xampp\htdocs\ibs\resources\views/admin/footer.blade.php ENDPATH**/ ?>