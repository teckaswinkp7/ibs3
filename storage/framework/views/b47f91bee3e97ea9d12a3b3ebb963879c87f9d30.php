    ...
    <div class="background-profile" style="margin-top: 100px;"> 
        <div class="profile-modal">
            ...
            <div class="row">
                ...
                <form action="<?php echo e(route('recieptpost')); ?>" method="post" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                      <div class="edit-course">
                        <p > Course : <?php echo e($student_course_offer[0]->courses_name); ?> </p>
                        <p > invoice Number : <?php echo e($invoicedata[0]->invoiceno); ?> </p>
                        <p> Amount Due: $<?php echo e($total[0]->amountdue); ?> </p>
                        <p> Issue Date :  
                        <?php 
...
?>
                        ...
                        <p> Balance Due: $<?php echo e($total[0]->balance_due); ?>  </p> 
                        <p > Status: <span class= "badge badge-danger " ><?php echo e($total[0]->status); ?> </span> </p>
...
<?php echo $__env->make('front/header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ibs\resources\views/front/invoice/recieptsubmit.blade.php ENDPATH**/ ?>